...
##
## NAUTILUS
## SCRIPT: 08_anyfile_show_LINUX_DOWNLOADS_WEB-PAGES.sh
##
## PURPOSE: Show various Linux DOWNLOADS web pages
...
do
   ...
   --title "Which LINUX DOWNLOADS web page to show?" \
   --height=400 \
   --text "\
Choose $ANOTHER linux-DOWNLOADS web page to show. Or Cancel.
...
set in the HTMLVIEWER var of the '.set_VIEWERvars.shi' include script." \
   ...
   "www.ubuntuupdates.org" "http://www.ubuntuupdates.org" \
   "packages.debian.org" "http://packages.debian.org" \
   "sourceforge.net" "http://sourceforge.net" \
   "tombuntu.com" "http://tombuntu.com" \
   "pkgs.org" "http://pkgs.org" \
   "code.google.com/p/ubuntu-debs" "http://code.google.com/p/ubuntu-debs"
   )
