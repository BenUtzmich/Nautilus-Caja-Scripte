...
##
## NAUTILUS
## SCRIPT: 08_anyfile_show_LINUX_NEWS_WEB-PAGES.sh
##
## PURPOSE: Show various Linux NEWS web pages
...
do
   ...
   --title "Which LINUX NEWS web page to show?" \
   --height=400 \
   --text "\
Choose $ANOTHER linux-NEWS web page to show. Or Cancel.
...
set in the HTMLVIEWER var of the '.set_VIEWERvars.shi' include script." \
   ...
   "www.debian-news.org" "http://www.debian-news.org" \
   "news.gnome.org" "http://news.gnome.org" \
   "lwn.net (Linux Weekly News)" "http://lwn.net" \
   "newsgroups.derkeiler.com" "http://newsgroups.derkeiler.com"
   )
