...
##
## NAUTILUS
## SCRIPT: 08_anyfile_show_LINUX_TUTORIAL_WEB-PAGES.sh
##
## PURPOSE: Show various Linux TUTORIAL web pages
...
##
##          Goes to the selected URL using an HTML-veiwer of the
##          user's choice.
##
## HOW TO USE: 
...
do
   ...
   --title "Which LINUX TUTORIAL web page to show?" \
   --height=400 \
   --text "\
Choose $ANOTHER linux-TUTORIAL web page to show. Or Cancel.
...
set in the HTMLVIEWER var of the '.set_VIEWERvars.shi' include script." \
   ...
   "digitalmedia.oreilly.com" "http://digitalmedia.oreilly.com" \
   "www.yolinux.com" "http://www.yolinux.com" \
   "www.go2linux.org" "http://www.go2linux.org" \
   "askubuntu.com" "http://askubuntu.com" \
   "docs.fedoraproject.org" "http://docs.fedoraproject.org" \
   "tldp.org (The Linux Documentation Project)" "http://tldp.org"
   )
