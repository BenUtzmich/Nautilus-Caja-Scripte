...
##          (video-audio-container): video in Xvid format and
##          audio in MP3 format --- in an 'avi' container.
##             
...
##       this script specifies the 'avi' container format.
##
##       NOTE on TESTING:
...
##            'ffmpeg clip'  or  'ffmpeg start duration xvid avi' or ...
##
...
##            But some examples show '-ss' BEFORE the '-i'.
##
...
## Changed: 2012jun18 Put '-ss' parm after '-i'. Added 'xvid-mp3' to FILEOUT.
...
FILEOUT="${FILENAMECROP}_START${STARTTIME}_DURATION${DURATION}_xvid-mp3.avi"
...
## avi-xvid-mp3 (container-video-audio).
#################################################################
...
##    [libxvid @ 0x8c26760]Invalid pixel aspect ratio 0/1
##    Video encoding failed
## FROM AN INPUT h264-aac.mp4 FILE OF SIZE 368X27.
## WHAT NEXT? TRY OTHER -vcodec CONVERSION PARMS?
