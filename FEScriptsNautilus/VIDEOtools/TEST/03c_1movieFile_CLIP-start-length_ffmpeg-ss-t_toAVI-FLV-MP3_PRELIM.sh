...
##          (video-audio-container): video in 'flv' format and
...
##
##########################################################################
## Started: 2012jun25 Based on the FE Nautilus Scripts
##          03c_1movieFile_CLIP-start-length_ffmpeg-ss-t_toAVI-XVID-MP3.sh
##                    and
##          03k_1movieFile_CLIP-start-length_ffmpeg-ss-t_toFLV-FLV-MP3.sh
## Changed: 2012
#########################################################################
...
FILEOUT="${FILENAMECROP}_START${STARTTIME}_DURATION${DURATION}_flv-mp3.avi"
...
## avi-flv-mp3 (container-video-audio).
#################################################################
