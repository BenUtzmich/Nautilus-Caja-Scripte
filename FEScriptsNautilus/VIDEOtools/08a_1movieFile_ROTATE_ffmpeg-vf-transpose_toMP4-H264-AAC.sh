...
##
## Nautilus
## SCRIPT: 08a_1movieFile_ROTATE_ffmpeg-vf-transpose_toMP4-H264-AAC.sh
##
...
##
##          Uses 'ffmpeg' with '-vf' (vfilters) --- and container, video codec,
...
##
#############################################################################
## Started: 2016oct15 Based on FE Nautilus Script
##                    07_1movieFile_RESIZE-WxHpixels_ffmpeg-s_toMP4-H264-AAC.sh
## Changed: 2016oct21 Changed scriptname from '08_' prefix to '08a_', after
##                    adding a '08b_' ROTATE script based on 'mencoder'
##                    instead of 'ffmpeg' --- as an alternative rotate option.
#############################################################################
...
###########################################################
## Prompt for Rotate option number --- for -vf "transpose=?".
...
FILEOUT="${FILENAMECROP}_ROTATED_opt${ROTATE_NUM}_ffmpeg-h264-aac.mp4"
...
## Most of these options come FROM the FE 'VIDCAP_CONVERT' Nautilus Script 
