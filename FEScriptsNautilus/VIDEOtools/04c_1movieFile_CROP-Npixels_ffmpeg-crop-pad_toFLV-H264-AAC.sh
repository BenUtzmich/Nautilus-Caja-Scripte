...
##
## Nautilus
## SCRIPT: 04c_1movieFile_CROP_Npixels_ffmpeg-crop-pad_toFLV-H264-AAC.sh
##
## PURPOSE: Crop a user-specified number of pixels from the
##          bottom/top/left/right of a movie file --- and make the
##          output movie file an FLV-H264-AAC container-video-audio format.
##
...
##
##          Uses 'ffmpeg' with '-crop...' and '-pad...' and '-f flv'
...
FILEOUT="${FILENAMECROP}_CROPPED_h264-aac.flv"
