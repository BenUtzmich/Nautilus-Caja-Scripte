...
##            'ffmpeg clip'  or  'ffmpeg ss mkv matroska h.264 mp3'   or ...
##
...
##            This indicates that '-ss' and '-t' should be AFTER the '-i' parm.
...
##           '03d_oneMovie_CLIP_vidout-H264_audout-VORBIS_inMKV_ffmpeg.sh'.
...
## Changed: 2012jun18 Put '-ss' parm after '-i'. Added 'h264-mp3' to FILEOUT.
...
Allowed suffixes:
mp4, mkv, flv, avi, wmv, asf, mov, mpg, mpeg, ogg, ogv, 3gp, vob
...
will be MP3.  The output container format will be MKV (Matroska).
------------------------------------------------------------------------
...
FILEOUT="${FILENAMECROP}_START${STARTTIME}_DURATION${DURATION}_h264-mp3.mkv"
...
##                        indicates Yes for a given input format ---
