...
##
## Nautilus
## SCRIPT: 06a_1movieFile_CHGaudioVOLUME_ffmpeg-vol_toMP4-H264-AAC.sh
##
## PURPOSE: Change the audio volume of a movie file --- and make the
##          format of the output file MP4-H264-AAC (container-video-audio).
##
...
##
##          We make the output movie file in the mp4-h264-aac format
...
##
##       This script works by specifying the container-video-audio formats
...
##           or 'ffmpeg audio volume mp4 h.264 aac' or ...
##
## REFERENCES:
...
##               06b_1movieFile_CHGaudioVOLUME_ffmpeg-vol_toMP4-H264-AAC.sh
##                    and
##               04d_1movieFile_CROP_Npixels_ffmpeg-crop-pad_toMP4-H264-AAC.sh
...
mp4, mkv, avi, flv, wmv, asf, mov, mpeg, mpg, ogg, ogv, 3gp, vob
...
FILEOUT="${FILENAMECROP}_audiopct${AUDIOPCNT}_h264-aac.mp4"
...
## an mp4-h264-aac output file format (container-video-audio).
###################################################################
## REFERENCE:
## http://blog.adtools.co.uk/easily-reduce-or-increase-flv-video-audio-levels-easily-using-ffmpeg/693/
##################################################################
