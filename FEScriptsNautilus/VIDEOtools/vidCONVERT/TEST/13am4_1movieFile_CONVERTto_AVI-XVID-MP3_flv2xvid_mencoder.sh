...
##
## Nautilus
## SCRIPT: 13am4_1movieFile_CONVERTto_AVI-XVID-MP3_flv2xvid_mencoder.sh
##
## PURPOSE: Convert a movie file to an 'xvid' '.avi' movie file.
##          Uses 'mencoder'.
##
##          These 'mencoder' parms were reportedly used to  convert a
##          '.flv' container movie file to an 'xvid' '.avi' movie file.
##
...
##          audio codec and '-ovc xvid' with '-xvidencopts' parms
...
##          http://www.linuxquestions.org/questions/linux-software-2/how-to-convert-flv-files-606013/
##      OR
##          do a web search with keywords like 'mencoder xvid avi mp3'
##
##
...
##########################################################
## Use 'mencoder' to make the XVID 'avi' file.
##########################################################

xterm -hold -fg white -bg black -geometry 90x24+100+100 -e \
      mencoder "$FILENAME" -ovc xvid \
      -xvidencopts bitrate=768:autoaspect -vf pp=lb \
