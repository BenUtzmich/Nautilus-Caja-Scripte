...
##
## Nautilus
## SCRIPT: 13am3_1movieFile_CONVERTto_AVI-MPEG4-MP3_flv2divx_mencoder.sh
##
## PURPOSE: Convert a movie file to a 'divx' '.avi' movie file.
##          Uses 'mencoder'.
##
##          These 'mencoder' parms were reportedly used to  convert a
##          '.flv' container movie file to a 'divx' '.avi' movie file
##
...
##########################################################
## Use 'mencoder' to make the DIVX 'avi' file.
##########################################################

xterm -hold -fg white -bg black -geometry 90x48+100+100 -e \
      mencoder "$FILENAME" -ovc lavc \
         -lavcopts vcodec=mpeg4:vbitrate=768:mbd=2:v4mv:autoaspect \
         -vf pp=lb \
