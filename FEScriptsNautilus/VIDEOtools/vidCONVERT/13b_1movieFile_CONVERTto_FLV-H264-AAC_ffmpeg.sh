...
##
## Nautilus
## SCRIPT: 13ff2_1movieFile_CONVERTto_FLV-H264-AAC_ffmpeg.sh
##
...
#########################################################################
## Started: 2012jun18
## Changed: 2012jun19 Put output in curdir instead of /tmp.
##############################################################################
...
# FILEOUT="/tmp/${FILENAMECROP}_NEW_h264-aac.flv"
FILEOUT="${FILENAMECROP}_NEW_h264-aac.flv"
