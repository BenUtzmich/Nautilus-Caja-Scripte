...
##
## Nautilus
## SCRIPT: 14_1movieFile_FLIPhorizontally_ffmpeg-hflip_toMP4-H264-AAC.sh
##
## PURPOSE: Horizontally-flip a movie file.
##
## METHOD:  There is no prompt for parameters.
##
##          Uses 'ffmpeg' with '-vf hflip' --- and container, video codec,
##          and audio codec specified with '-f', '-vcodec', and '-acodec
##          respectively.
##
##          Shows the new, 'h-flipped' movie file in a movie player.
##
##   NOTE on TESTING:
...
##        'avi', 'asf', 'flv', 'mkv', 'mp4', 'mpg', 'mpeg', 'wmv'
##     and others.
##
...
FILEOUT="${FILENAMECROP}_H-FLIPPED_h264-aac.mp4"
...
###################################################################
## Use 'ffmpeg' to make the 'h-flipped' movie file.
###################################################################
