...
##
## NAUTILUS
## SCRIPT: xx_anyfile_START-NAUTILUS-at-selected-DIR_radiolist-nautilus.sh
##
## PURPOSE: This script starts up Nautilus at a selected directory.
##
...
# $DIR_NautilusScripts/.START-NAUTILUS-or-CAJA-at-selected-DIR_radiolist-filemgr.sh "nautilus"

$HOME/.gnome2/nautilus-scripts/FILESlists/.START-NAUTILUS-or-CAJA-at-selected-DIR_radiolist-filemgr.sh "nautilus"
