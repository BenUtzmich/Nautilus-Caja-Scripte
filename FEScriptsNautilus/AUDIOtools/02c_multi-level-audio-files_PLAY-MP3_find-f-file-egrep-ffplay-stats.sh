...
##
## Nautilus
## SCRIPT: 02c_multi-level-audio-files_PLAY-MP3_find-f-file-egrep-ffplay-stats.sh
##
...
##
##          Plays the audio files with a player, currently 'ffplay'.
##
...
FILENAMES=`find . -type f -exec file {} \; | egrep 'MPEG.*, layer III' | cut -d: -f1`
