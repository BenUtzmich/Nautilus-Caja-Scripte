...
##
## Nautilus
## SCRIPT: 00_anyfile_shoHELP_Mplayer-h.sh
##
## PURPOSE: Shows the help that 'mplayer -h' displays.
##
## METHOD:  Puts the 'mplayer -h' output in a text file in /tmp.
##
...
FILEOUT="/tmp/${USER}_mplayer-h_HELP.txt"
...
###########################################################
## Put the 'mplayer -h' output in the output file.
###########################################################
