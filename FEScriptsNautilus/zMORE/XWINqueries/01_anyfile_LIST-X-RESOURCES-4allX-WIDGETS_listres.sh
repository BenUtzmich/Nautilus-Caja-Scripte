...
##
## NAUTILUS
## SCRIPT: 00_anyfile_LIST_X-RESOURCES_4allX-WIDGETS_listres.sh
##
## PURPOSE: List the resources for ALL X widgets, via 'listres'.
##
## METHOD: Puts the output of 'listres' in a text file and then
...
OUTLIST="/tmp/${USER}_list_resAllWidgets.lis"
...
#####################################################
## Run 'listres' to create the main part of the list.
#####################################################

EXECHECK=`which listres`
