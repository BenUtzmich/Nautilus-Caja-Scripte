...
##
## Nautilus
## SCRIPT: 00_multiFiles_RENAME_SPACE2underscore_tr-mv.sh
##
## PURPOSE: For each of the user-selected files, we convert
##          space characters in each filename to underscores.
##
## METHOD:  The conversion of each space to an underscore is done
##          with the 'tr' command.
...
##
## BATCH NOTE:
##       Use with care. If you rename a bunch of files,
##       if you have to rename them back to the original
##       names, GOOD LUCK --- or make a script like this,
