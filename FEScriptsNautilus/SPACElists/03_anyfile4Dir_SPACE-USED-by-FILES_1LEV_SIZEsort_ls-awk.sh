...
##
## Nautilus
## SCRIPT: 03_anyfile4Dir_SPACE-USED-by_FILES_1LEV_SIZEsort_ls-awk.sh
##
## PURPOSE: This utility will list the files in the current directory
##          sorted by size --- showing all the sizes in the same
##          easily-comparable units (MB), and
##          with rigid (highly readable) columnar formatting.
##
##          The directories in the current directory are also listed.
##
## METHOD:  This script puts the output of 'ls' in a text file --- after
##          piping it through 'sed', 'grep', 'sort', and 'awk' to produce
...
##             ANY file (or directory) in the desired current directory.
...
OUTFILE="${USER}_space_files_onelevel_sizesort_temp.lis"
...
$SCRIPT_DIRNAME
  ...
  It ran the 'ls -la' command on host $HOST_ID .
