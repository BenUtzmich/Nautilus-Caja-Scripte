...
##
## Nautilus
## SCRIPT: 04_anyfile4Dir_SPACE-USEDby_FILES_1LEV_AGEsort_ls-awk.sh
##
...
##          piping the output through 'sed', 'grep', and 'awk' --- to
##          produce a nicely formatted report.
##
...
##
## BUT it may be useful to have the report file in the directory
## to which the report applies.
#################################################################

OUTFILE="${USER}_space_files_onelevel_agesort_temp.lis"
