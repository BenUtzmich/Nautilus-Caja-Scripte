...
##     
## (Nautilus)
## SCRIPT: 04_anyfile_show_PCENT-MEM4processes_ps-awk-sort.sh
##
## PURPOSE: Lists ALL the processes on 'this' host, highlighting the
##          'top' processes in terms of the 'ps -e' %MEM column
##          (percent resident memory used) --- by sorting those top
...
OUTFILE="/tmp/${USER}_ps_pcentmem_sort.lis"
