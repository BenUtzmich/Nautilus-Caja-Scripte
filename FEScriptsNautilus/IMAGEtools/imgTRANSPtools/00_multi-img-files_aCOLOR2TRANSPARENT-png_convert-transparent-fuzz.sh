...
##
## Nautilus
## SCRIPT: 00_multi-img-files_aCOLOR2TRANSPARENT-png_convert-transparent-fuzz.sh
##
## PURPOSE: For a selected set of image files --- '.jpg', '.png', '.gif' or
##          whatever, converts them to TRANSPARENT '.png' files by making
##          a specified color transparent.
##
## METHOD:  Uses 'zenity --entry' to ask user for a color to make transparent.
##
##          Uses 'zenity --entry' to prompt for a fuzz percent (for making 'nearby'
##          colors transparent).
##
