...
##
## Nautilus
## SCRIPT: color09_1imgfile_toGRAY_convert-colorspace.sh
##
## PURPOSE: For one image file (jpg, png, gif, whatever),
##          makes a 'gray-scale' file from the image file.
##
## METHOD:  There is no prompt for a parameter.
##
##          Uses ImageMagick 'convert' with the '-colorspace' option.
##
...
##
## Reference: http://www.imagemagick.org/Usage/color_mods/#grayscale
##
...
OUTFILE="${FILENAMEMID}_GRAYSCALE.$FILEEXT"
...
##################################################################
## Use 'convert' to make the 'gray-scale' file.
##################################################################

convert "$FILENAME"  -colorspace Gray  "$OUTFILE"


####################################################
## Show the 'gray-scale' file.
####################################################
