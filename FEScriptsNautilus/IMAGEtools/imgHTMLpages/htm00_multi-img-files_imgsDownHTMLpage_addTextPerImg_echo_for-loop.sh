...
##
## Nautilus
## SCRIPT: htm00_multi-img-files_imgsDownHTMLpage_addTextPerImg_echo_for-loop.sh
##
...
## Changed: 2013may30 Moved sample text above images to below images.
## Changed: 2013oct20 Added '_addTextPerImg' to script name.
###########################################################################
...
###################################
  ...
  HTMFILE="00_temp_imgCells_downPage.htm"
# HTMFILE="temp.htm"
...
<p align=\"center\">
Description of image below goes here.<br>
The description can be on multiple lines, like this.
