...
##
## Nautilus
## SCRIPT: htm02_multi-img-files_imgsSLIDESHOW_NOfit2page_echo_for-loop.sh
##
## PURPOSE: Generate a SLIDESHOW HTML page for showing a sequence of
##          user-selected image files ('.jpg' or '.png' or '.gif' or whatever)
##          displayed in an area at least 300 pixels high on the HTML page.
##
##          Controls (links) are provided on the page for
...
##           'add-load-listener.js' and 'slideshow_funcs.js' ---
...
###################################
  ...
  HTMFILE="00_slideshow_NOfit2page.htm"
# HTMFILE="00_SLIDESHOW_NOfit2page.htm"
...
<title>
SLIDESHOW - viewport at least 300 pixels high
</title>
...
<script type=\"text/javascript\"
 src=\"./javascripts/slideshow_funcs.js\">
</script>
...
<p align=\"justify\">
By default, images are shown at their original (actual pixels) size in a
'viewport' area. The 'viewport' is an area within your HTML viewer
(web browser) window, below.

<p align=\"justify\">
You have zoomIN, zoomOUT, and (return-to-)original-size functions
--- below, on the left, beside the image. These controls can be used to
over-ride the default 'actual size' image display function.
If the image is too large, try 'zoomOUT'.
...
<p align=\"justify\">
<b>Bottom</b> of the <b>SLIDESHOW ('as-is' display of image sizes)</b> page.
...
## 2) Copy the 'add-load-listener.js' and 'slideshow_funcs.js'
...
if test ! -f "$CURDIR/javascripts/slideshow_funcs.js"
then
   cp "$DIR_THISSCRIPT/.javascripts/slideshow_funcs.js" \
      "$CURDIR/javascripts/slideshow_funcs.js"
fi
