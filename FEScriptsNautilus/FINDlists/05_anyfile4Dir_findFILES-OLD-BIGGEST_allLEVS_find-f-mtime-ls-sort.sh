#!/bin/sh
##
## SCRIPT: 05_anyfile4Dir_findFILES-OLD-BIGGEST_allLEVS_find-f-mtime-ls-sort.sh
##
...
OUTFILE="${USER}_temp_dirFilesRecursiveLIST_OLD-BIGones_find-mtime-ls-sort.txt"
