#!/bin/sh
##
## SCRIPT: 05_anyfile4Dir_findFILES-YOUNG-SIZESORT_allLEVS_find-NOTdir-mtime-ls-sort.sh
##
...
## Changed: 2013oct27 Changed script name from 'YOUNG-BIGGEST' to 'YOUNG-SIZESORT'
...
OUTFILE="${USER}_temp_dirFilesRecursiveLIST_YOUNG-BIGones_find-mtime-ls-sort.txt"
...
Enter N days, for this 'files modified recently' utility." \
   --text "\
Enter  an integer.
Examples:  7 to see files modified in the past week; 30 for files modified in the past month." \
   --entry-text "7")
...
In other words, these are YOUNG files that are SIZE-SORTED.
